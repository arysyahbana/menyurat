                    ...
                    <div class="accordion-item border-bottom">
                        ...
                        <div id="content_of_letter" class="accordion-collapse collapse" data-bs-parent="#accordionParent">
                            <div class="accordion-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        <label><strong>Detail Permohonan</strong></label>
                                    </div>
                                    <div class="col-md-9">
                                        <div id="contents_second_list">
                                            @if (old("contents.second"))
                                                @foreach (old("contents.second") as $index => $item)
                                                    <div class="mb-3">
                                                        <label for="{{ sprintf('contents_second_%s', $index) }}">Poin {{ $loop->iteration }}</label>
                                                        <textarea name="contents[second][]" id="{{ sprintf('contents_second_%s', $index) }}" class="form-control" rows="3" required>{{ $item }}</textarea>
                                                    </div>
                                                @endforeach
...
@section("javascript")
    ...
    <script src="{{ asset('assets/js/buat_surat/application.js') }}"></script>
