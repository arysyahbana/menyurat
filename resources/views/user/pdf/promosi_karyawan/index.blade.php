...
@section('content')
    ...
    <div class="mt-3">
        <div style="text-align: center">
            ...
            <p style="margin-top: -10px; font-size: 10pt; font-style: bold;">PROMOSI JABATAN KARYAWAN</p>
        </div>

        <div style="font-size: 11pt">
            <h4><u>Menimbang:</u></h4>
            <div style="margin-top: -20px; margin-bottom: 30px;">
                <ol id="considerings_data">
                    @if (old("considerings"))
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top;">
                                <ol>
                                    <li>
                                        <span>Jabatan</span>
                                        <span id="position_data">: {{ old("position") ?? $logs["position"] ?? "[Jabatan semula]" }}</span=>
                                    </li>
                                    ...
                                    <div id="optionals_data">
                                        @if(old("optionals"))
                                            @foreach (old("optionals") as $index => $item)
                                                <li id="{{ sprintf('optionals_%s_data', $index) }}">
                                                    <span class="row">
                                    ...
                                    <div id="new_optionals_data">
                                        @if(old("new_optionals"))
                                            @foreach (old("new_optionals") as $index => $item)
                                                <li id="{{ sprintf('new_optionals_%s_data', $index) }}">
                                                    <span class="row">
